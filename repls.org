...
** What's a REPL?
   ...
   In the case of Clojure we don't just have one, but several REPLs to choose
   from, each with their own use case. That's not to mention ClojureScript,
   where we have even more options. How do you make sense of this all? The
   answer: by reading this guide.
