...
*** Node.js
    ...
    on [[Bootstrapped ClojureScript
     REPLs][Bootstrapped ClojureScript REPLs]].
...
(let [username (first planck.core/*command-line-args*)]
  ...
  (if username
    ...
    (-write planck.core/*err* "Usage: stargazers <github username>")))
#+END_SRC
